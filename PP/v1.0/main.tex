...
\input{cost_estimation/cost_estimation}
\input{tasks_schedule/tasks_schedule}
\input{resources_allocation/resources_allocation}
\input{project_risks/project_risks}
